...
export default function PageControls({ current, total, onPrevious, onNext, zoom, onZoomIn, onZoomOut, mode }) {
  return (
      ...
      <div className="mx-auto flex max-w-4xl items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center rounded-xl border border-white/10 bg-zinc-900 sm:hidden">
            ...
            <span className="w-12 text-center text-[11px] font-bold text-zinc-300">{zoom}%</span>
